...
class SurveyResultCommentsService(ABC):
    @abstractmethod
    def save_survey_result_comment(self, survey_result_comment: SurveyResultComments) -> SurveyResultComments:
        """
    ...
    @abstractmethod
    def get_survey_result_comment(self, id: int) -> Optional[SurveyResultComments]:
        """
    ...
    @abstractmethod
    def get_survey_result_comments_by_survey_result(self, survey_result_id: int) -> List[SurveyResultComments]:
        """
    ...
    @abstractmethod
    def get_all_survey_result_comments(self) -> List[SurveyResultComments]:
        """
    ...
    @abstractmethod
    def update_survey_result_comment(self, survey_result_comment: SurveyResultComments) -> SurveyResultComments:
        """
    ...
    @abstractmethod
    def delete_survey_result_comment(self, id: int) -> None:
        """
