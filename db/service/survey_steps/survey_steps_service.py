...
class SurveyStepService(ABC):
    @abstractmethod
    def save_survey_step(self, survey_step: SurveyStep) -> SurveyStep:
        """
    ...
    @abstractmethod
    def get_survey_step(self, id: int) -> Optional[SurveyStep]:
        """
    ...
    @abstractmethod
    def get_all_survey_steps(self, survey_id: int) -> List[SurveyStep]:
        """
    ...
    @abstractmethod
    def update_survey_step(self, survey_step: SurveyStep) -> SurveyStep:
        """
