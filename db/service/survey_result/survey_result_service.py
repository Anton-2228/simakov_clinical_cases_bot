...
class SurveyResultService(ABC):
    @abstractmethod
    def save_survey_result(self, survey_result: SurveyResult) -> SurveyResult:
        """
    ...
    @abstractmethod
    def get_survey_result(self, id: int) -> Optional[SurveyResult]:
        """
    ...
    @abstractmethod
    def get_survey_results_by_user(self, user_id: int) -> List[SurveyResult]:
        """
    ...
    @abstractmethod
    def get_survey_results_by_user_and_survey(self, user_id: int, survey_id: int) -> List[SurveyResult]:
        """
    ...
    @abstractmethod
    def get_all_survey_results(self) -> List[SurveyResult]:
        """
    ...
    @abstractmethod
    def delete_survey_result(self, id: int) -> None:
        """
